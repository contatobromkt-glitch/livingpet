// Celulares com moldura realista 3D (metal, ilha dinâmica, brilho, sombra) e
// as TELAS REAIS do app LivingPet dentro (feitas em HTML/CSS, fiéis à marca).
const A = import.meta.env.BASE_URL;

function Frame({ children, clinico }) {
  return (
    <div className="phone">
      <div className="island" />
      <div className="gloss" />
      <div className={'screen ' + (clinico ? 'screen-clinico' : 'screen-ludico')}>
        {children}
      </div>
    </div>
  );
...
export function PhoneFicha() {
  return (
    <Frame clinico>
      <div className="sc-pad" style={{ paddingTop: 40 }}>
